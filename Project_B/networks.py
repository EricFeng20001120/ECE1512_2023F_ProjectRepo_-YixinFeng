...
class ConvNet(nn.Module):
    ...
    def _get_normlayer(self, net_norm, shape_feat):
        ...
        if net_norm == 'batchnorm':
            ...
            num_groups = 4
            if shape_feat[0] % num_groups != 0:
                num_groups = shape_feat[0]  # Fallback to instance norm behavior if not divisible
            return nn.GroupNorm(num_groups, shape_feat[0], affine=True)
        elif net_norm == 'none':
            return None
        else:
